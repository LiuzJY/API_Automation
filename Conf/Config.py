...
class Config:
    # titles:
    TITLE_TEST = "activity_test"
    TITLE_RELEASE = "activity_release"
    TITLE_EMAIL = "mail"
    ...
    def __init__(self):
        ...
        self.log = Log.MyLog()
        self.test_path = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir))
        ...
        self.versionCode_testg = self.get_conf(Config.TITLE_TEST, Config.VALUE_VERSION_CODE)
        ...
        self.loginInfo_test = self.get_conf(Config.TITLE_TEST, Config.VALUE_LOGIN_INFO)
